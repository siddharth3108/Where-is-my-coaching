...
<html lang="en">
    <head>
        ...
        <title>Student Login Home</title>
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent"  >
                <ul class="navbar-nav mr-auto"  >
                    <li class="nav-item dropdown">
                        <a style="color:gray;font-size: 21px; " class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Contact
                        </a>
  ...
  <!--------------------------------------------------------------------------------->              
                <nav aria-label="breadcrumb" style="height:30px;margin-top: -28px">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" ><a style="font-size:21px;color:black;" ><%=session.getAttribute("Mobile")%></a></li>
                        <li class="breadcrumb-item" ><a style="font-size:21px;color:black;" href="Logout.jsp">LogOut</a></li>
                    </ol>
                </nav>
 <!---------------------------------------------------------------------------------------> 
            </div>
